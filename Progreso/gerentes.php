	    ...
	    <div class="container">
			...
			<div class="row">
				<div class="col s12 m6 offset-m3 input-field">
		            <a href="agregarGerente.php" class="btn" style="width: 100%">Agregar Gerente</a>
		        </div>
				<div class="col s12 m6 offset-m3 input-field">
		            <a href="editarGerente.php" class="btn" style="width: 100%">Editar Gerente</a>
		        </div>
				<div class="col s12 m6 offset-m3 input-field">
		            <a href="eliminarGerente.php" class="btn" style="width: 100%">Eliminar Gerente</a>
		        </div>		        
		     </div>	
